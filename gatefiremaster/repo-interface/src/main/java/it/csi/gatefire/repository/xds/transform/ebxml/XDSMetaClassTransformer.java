...
/**
 * Base class for transformers of {@link XDSMetaClass} and ebXML
 * representations.
 * 
 * @param <E> the ebXML type.
 * @param <C> the {@link XDSMetaClass} type.
...
public abstract class XDSMetaClassTransformer<E extends EbXMLRegistryObject, C extends XDSMetaClass> {
	 ...
	 * 
	 * @param patientIdExternalId          the external ID of the patient ID.
	 * @param patientIdLocalizedString     the localized string of the patient ID.
	 * @param uniqueIdExternalId           the external ID of the unique ID.
	 * @param uniqueIdLocalizedString      the localized string of the unique ID.
	 * @param limitedMetadataAttributeName the classification defining the
	 *                                     limitedMetadata.
	 */
	protected XDSMetaClassTransformer(String patientIdExternalId, String patientIdLocalizedString,
			String uniqueIdExternalId, String uniqueIdLocalizedString, String limitedMetadataAttributeName,
	 ...
	 * 
	 * @param metaData      the meta data to transform. Can be <code>null</code>.
...
//			metaData.setExtraMetadata(((ExtraMetadataHolder) ebXML).getExtraMetadata());
		...
		metaData.setLimitedMetadata(ebXML.getClassifications().stream().anyMatch(
				classification -> limitedMetadataAttributeName.equals(classification.getClassificationNode())));
	 ...
	 * 
	 * @param metaData      the meta data instance containing the attributes.
	 * @param ebXML         the ebXML instance receiving the attributes.
	 * @param objectLibrary the object library.
	 */
	 ...
	 * 
	 * @param metaData      the meta data instance containing the slots.
	 * @param ebXML         the ebXML instance receiving the slots.
	 * @param objectLibrary the object library.
	 */
	 ...
	 * 
	 * @param metaData the meta data instance receiving the slots.
	 * @param ebXML    the ebXML instance containing the slots.
	 */
	 ...
	 * 
	 * @param metaData      the meta data instance containing the classifications.
	 * @param ebXML         the ebXML instance receiving the classifications.
	 * @param objectLibrary the object library.
	 */
	 ...
	 * 
	 * @param metaData the meta data instance receiving the classifications.
	 * @param ebXML    the ebXML instance containing the classifications.
	 */
	 ...
	 * 
	 * @param metaData      the meta data instance containing the external
	 *                      identifiers.
