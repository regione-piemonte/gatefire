...
<link
	...
	rel="stylesheet">
<link
	href="<c:url value="/resources/css/theme3/jquery-ui.theme.min.css"/>" rel="stylesheet"
	type="text/css" />
...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
		<a class="navbar-brand" href="${ctx }/"> <img
			src="<c:url value="/resources/images/Logo_CSI_negativo.png" />" alt="LOGO CSI"/></a>
