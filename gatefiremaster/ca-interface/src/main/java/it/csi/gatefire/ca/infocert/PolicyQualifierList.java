...
@XmlRootElement(name = "policyQualifierList")
public class PolicyQualifierList {

    @XmlElement(required = true)
    protected List<PolicyQualifier> policyQualifier;
     ...
     * {@link PolicyQualifier }
     * 
     * 
     */
    public List<PolicyQualifier> getPolicyQualifier() {
        if (policyQualifier == null) {
            policyQualifier = new ArrayList<PolicyQualifier>();
        }
