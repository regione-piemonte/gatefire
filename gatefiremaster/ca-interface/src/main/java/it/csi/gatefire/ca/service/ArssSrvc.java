...
public interface ArssSrvc {
	...
	SessionIdResult openSession(SessionInput sessionInput, Long idEvento);

	Result closeSession(String sessionId, SessionInput sessionInput, Long idEvento);
